...
class Cetak_sk_satker extends MX_Controller {
  ...
  var $ar_unor = array();
	public function __construct() {
		...
		$this->_addField($table, 'dtgltetap', 'Tgl. Penetapan', true, true);
		...
		$this->_add2ListField($table, 'iunorid, cnosk, dtglsk, cnosk2, lampiran, ittdid, ctahun');//dtmt, dtgltetap, 
	...
	function listBox_app_t_usulan_sk_lampiran($value, $datas) {
	  $input = "";
	  $sql = "select tfile2 from app_t_usulan_sk where id = '{$datas->app_t_usulan_sk_id}'";
