...
class Laporan_dashboard extends MX_Controller {
  var $prefix = 'app';
  var $table;
	public function __construct() {
		parent::__construct();
		$controller = "perbend/laporan_dashboard";
	...
	function lists($page_ke=0, $reports=false) {
      ...
      $html .= "<th>Jumlah</th>";
        ...
        //exit;
  		  ...
  		  >> <span onclick='_browse(\"".base_url()."perbend/detail_laporan_dashboard/index/0\");
              $(\"#detail_laporan_dashboard #q_app_t_usulan_iunorid\").val(\"{$kode->kode_satker}\");
                reload_grid(\"".base_url()."perbend/detail_laporan_dashboard/lists\", \"detail_laporan_dashboard\");' 
