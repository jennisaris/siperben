      ...
      //print_r($_POST);
        ...
        //print_r($orgs);
			...
			*/
			  ...
			  $html .= "<td>".$this->get_list_nama_pemangku($kode->id, 6, $reports)."</td>";
			  $html .= "<td>".$this->get_list_nama_pemangku($kode->id, 4, $reports)."</td>";
			  $html .= "<td>".$this->get_list_nama_pemangku($kode->id, 5, $reports)."</td>";
			  $html .= "<td>".$this->get_list_nama_pemangku($kode->id, 7, $reports)."</td>";
