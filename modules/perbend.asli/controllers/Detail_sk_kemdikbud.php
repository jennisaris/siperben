      ...
      //print_r($_POST);
        ...
        //print_r($orgs);
			...
			if ( $offset == 0 ) $norut = $no;
			  ...
			  $html .= "<td valign='top'>".$this->get_nama($kode->kpa, "ijabid2=1 and ckduker = {$kode->iunorid} and iusulanid != {$kode->id}")."</td>";
			   $html .= "<td valign='top'>".$this->get_nama($kode->bp, "ijabid2=2 and ckduker = {$kode->iunorid} and iusulanid != {$kode->id}")."</td>";
			   $html .= "<td valign='top'>".$this->get_nama($kode->bpn, "ijabid2=3 and ckduker = {$kode->iunorid} and iusulanid != {$kode->id}")."</td>";
