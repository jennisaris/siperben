  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      color: var(--ink);
      min-height: 100vh;
      background: radial-gradient(circle at top left, #dbeafe 0, #eef6ff 28%, #f8fafc 62%, #f1f5f9 100%)
    }
  ...
  <div class="hero">
    <div class="shell">
      <aside class="side">
        ...
        <h1>Daftar akses Siperben dengan cepat dan akurat.</h1>
        <p>Lengkapi data diri, pilih satuan kerja dan pangkat/golongan dari database, lalu unggah Surat Persetujuan KPA.
        </p>
        <div class="steps">
          <div class="step">
            <div class="num">1</div><span>Isi identitas operator sesuai data kepegawaian.</span>
          </div>
          <div class="step">
            <div class="num">2</div><span>Pilih satuan kerja dan pangkat/golongan yang sesuai.</span>
          </div>
          <div class="step">
            <div class="num">3</div><span>Upload Surat Persetujuan KPA dalam format PDF.</span>
          </div>
        </div>
      </aside>
      ...
      <main class="formwrap">
        ...
        <?php if (!empty($success)): ?>
          <div class="alert alert-success">Registrasi berhasil dikirim. Nomor registrasi Anda:
            <strong><?php echo html_escape($registration_id); ?></strong>.
          </div>
        <?php endif; ?>
        <?php if (!empty($errors)): ?>
          <div class="alert alert-error"><strong>Mohon perbaiki data berikut:</strong>
            <ul><?php foreach ($errors as $e): ?>
                <li><?php echo html_escape($e); ?></li><?php endforeach; ?>
            </ul>
          </div>
        <?php endif; ?>
        ...
        <form method="post" enctype="multipart/form-data" autocomplete="off">
          <div class="grid">
            <div class="field">
              ...
              <input id="nip" name="nip" type="text" inputmode="numeric" maxlength="18" pattern="[0-9]{18}" required
                value="<?php echo html_escape(isset($old['nip']) ? $old['nip'] : ''); ?>" placeholder="18 digit NIP">
              <div class="help">Contoh: 199504142019031009</div>
            </div>
            <div class="field">
              <label for="nama_lengkap">Nama Lengkap <span class="req">*</span></label>
              <input id="nama_lengkap" name="nama_lengkap" type="text" maxlength="200" required
                value="<?php echo html_escape(isset($old['nama_lengkap']) ? $old['nama_lengkap'] : ''); ?>"
                placeholder="Nama sesuai dokumen">
            </div>
            <div class="field full">
              <label for="satuan_kerja">Satuan Kerja <span class="req">*</span></label>
              <input id="satuan_kerja" name="satuan_kerja" list="satker_list" maxlength="200" required
                value="<?php echo html_escape(isset($old['satuan_kerja']) ? $old['satuan_kerja'] : ''); ?>"
            ...
            <div class="field">
              ...
              <input id="no_hp" name="no_hp" type="tel" maxlength="30" required
                value="<?php echo html_escape(isset($old['no_hp']) ? $old['no_hp'] : ''); ?>"
                placeholder="08xxxxxxxxxx">
            </div>
            <div class="field full">
              <label for="email">E-mail <span class="req">*</span></label>
              <input id="email" name="email" type="email" maxlength="150" required
                value="<?php echo html_escape(isset($old['email']) ? $old['email'] : ''); ?>"
          ...
          <div class="actions">
            ...
            <a href="<?php echo base_url(); ?>privileges/user_authentication" class="btn-secondary">Kembali ke Login</a>
